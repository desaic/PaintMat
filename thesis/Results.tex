...
It computes a set of micro-lenses which produce the desired caustic image.
...
In the second process, based on the work of Finckh et al.~\shortcite{Finckh:2010},
I use a \emph{B-spline node} to represent a smooth caustic surface.
