...
\end{figure*}
\biglet{I}{n} order to evaluate capabilities of our system, I implemented a number of existing translation processes.
Furthermore, the ease with which different algorithm components can be combined enables the creation of new combinations of translation processes. In this proposal, I will discuss two combinations in detail, while I can potentially make more combinations within the capabilities of the proposed system.
