...
\stepcounter{footnote}\footnotetext{Simultaneous perturbation stochastic approximation (SPSA).}
\stepcounter{footnote}\footnotetext{Simulated annealing (SA).}
\stepcounter{footnote}\footnotetext{Augmented Lagrangian method (ALM).}