...
\label{chap:struct}
\biglet{I}{n} this chapter, I describe the structure of the \emph{reducer tree} as well as all types of \emph{reducer nodes} that will be implemented in my framework. I also show the structure of individual \emph{tuners} and how they can be arranged into the \emph{tuner network}.
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.45]{figure/tunerCon.pdf}
\caption{ 
