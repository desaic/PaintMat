...
In this research, I take the first step in achieving this goal.

The main contribution of my thesis work can be summarized as follows:
Spec2Fab processes use a similar structure
Small set of common components
A unified model for Spec2Fab translation
